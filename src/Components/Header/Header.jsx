    ...
    <>
      <div className="md:min-h-screen w-full relative flex-center overflow-hidden">
        ...
        <div className="relative z-10 w-full h-full">
          <div className="md:w-[60%] text-left pb-6 mx-2 px-12 md:ml-10 py-12 md:py-0">
            <motion.p
          ...
          <div className="md:space-x-8 space-y-2 md:space-y-0 flex flex-col md:flex-row items-start justify-start w-[90%] md:w-full px-12 pt-4 md:ml-12 pb-10">
            ...
            <motion.button
              ...
              className="py-[12px] px-[26px] rounded-[5px] cursor-pointer text-[14px] md:text-[16px] font-[600] leading-[21px] bg-transparent text-white hover:bg-customRed border-2 border-white w-full md:w-[185px] hover:transition-all hover:duration-300 hover:border-customRed transition-all duration-300"
            >
              Explore Products
            </motion.button>
          </div>
